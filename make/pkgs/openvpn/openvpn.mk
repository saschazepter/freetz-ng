$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_OPENVPN_VERSION_24),2.4.12,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_25),2.5.11,2.6.16)))
...
$(PKG)_HASH_26:=05cb5fdf1ea33fcba719580b31a97feaa019c4a3050563e88bc3b34675e6fed4
