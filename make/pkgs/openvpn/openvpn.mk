$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_OPENVPN_VERSION_24),2.4.12,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_25),2.5.11,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_26),2.6.20,2.7.2))))
...
$(PKG)_HASH_27:=9c3e150a595fc9a375221f2fa9f10524a9c064536cf81c96e3ba66c735b86f26
