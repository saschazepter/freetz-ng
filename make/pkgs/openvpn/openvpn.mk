$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_OPENVPN_VERSION_24),2.4.12,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_25),2.5.11,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_26),2.6.19,2.7.1))))
...
$(PKG)_HASH_27:=9858477ec2894a8a672974d8650dcb1af2eeffb468981a2b619f0fa387081167
