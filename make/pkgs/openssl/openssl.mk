$(call PKG_INIT_BIN,$(if $(FREETZ_OPENSSL_VERSION_09),0.9.8zh,$(if $(FREETZ_OPENSSL_VERSION_10),1.0.2u,$(if $(FREETZ_OPENSSL_VERSION_11),1.1.1w,$(if $(FREETZ_OPENSSL_VERSION_30),3.0.17,3.5.3)))))
...
$(PKG)_HASH_3.5:=c9489d2abcf943cdc8329a57092331c598a402938054dc3a22218aea8a8ec3bf
