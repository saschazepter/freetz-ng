...
KERNEL_TOOLCHAIN_SOURCE:=$(KERNEL_TOOLCHAIN_COMPILER)-freetz-$(KERNEL_TOOLCHAIN_VERSION)-shared-glibc.tar.lzma
KERNEL_TOOLCHAIN_HASH:=$(call qstrip,$(FREETZ_DL_KERNEL_TOOLCHAIN_HASH))
KERNEL_TOOLCHAIN_SITE:=https://github.com/Freetz-NG/dl-mirror/releases/download/dl-toolchains-$(KERNEL_TOOLCHAIN_VERSION)

TARGET_TOOLCHAIN_VERSION:=$(call qstrip,$(FREETZ_DL_TARGET_TOOLCHAIN_VERSION))
TARGET_TOOLCHAIN_SOURCE:=$(TARGET_TOOLCHAIN_COMPILER)-freetz-$(TARGET_TOOLCHAIN_VERSION)-shared-glibc.tar.lzma
TARGET_TOOLCHAIN_HASH:=$(call qstrip,$(FREETZ_DL_TARGET_TOOLCHAIN_HASH))
TARGET_TOOLCHAIN_SITE:=https://github.com/Freetz-NG/dl-mirror/releases/download/dl-toolchains-$(TARGET_TOOLCHAIN_VERSION)

x:
	@echo $(KERNEL_TOOLCHAIN_SITE)x
	@echo $(KERNEL_TOOLCHAIN_VERSION)y
