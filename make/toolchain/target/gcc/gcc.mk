...
GCC_HOST_COMMON_CONFIGURE_ENV += CXXFLAGS="$(strip $(TOOLCHAIN_HOST_TARGET_CXXFLAGS))"
...
$(GCC_BUILD_DIR3)/.configured: $(GCC_BUILD_DIR2)/.installed $(GCC_TARGET_PREREQ) | binutils_target
	...
	(cd $(GCC_BUILD_DIR3); $(RM) config.cache; \
		...
		CXXFLAGS_FOR_BUILD="$(TOOLCHAIN_HOST_TARGET_CXXFLAGS) -O2 -I$(HOST_TOOLS_DIR)/include" \
